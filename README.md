...
- Web evidence synthesis: `web.answer` is the first-choice Google-like route with search expansion, research/fetch/render/archive fallback, verification, grounded LLM synthesis with URL retention, answer TTL cache, source diversity, and structured cards for follow-up/UI use.
